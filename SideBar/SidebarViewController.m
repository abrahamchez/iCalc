...
//    self.tableView.backgroundColor = [UIColor colorWithWhite:0.2f alpha:1.0f];
    ...
    _menuItems = @[@"colors", @"turquoise", @"emerland", @"blue", @"yellow", @"orange", @"red", @"purple"];
}
...
//        photoController.photoFilename = photoFilename;
        ...
        NSString *textToWrite = [NSString stringWithFormat:@"%@", [_menuItems objectAtIndex:indexPath.row]];
        mVC.textColor = textToWrite;
